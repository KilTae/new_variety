...
if choose == "Fruit Searching":
    ...
    # Elasticsearch 호스트 및 포트 설정
        es = Elasticsearch(['https://smw-elasooktic.es.us-east-2.aws.elastic-cloud.com:443'], http_auth=('elastic', 'BDY8U4JsIkRJMGlvuYyvuf2C'))
    ...
    # OpenAI API 키 설정
    openai.api_key = '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'
    system_instruction = """
너는 과일추천자야. 
아래는 딸기 종류야. 
...
""" 
    ...
    st.header("🤖 Elasooktic Smartfarm Chatbot")
